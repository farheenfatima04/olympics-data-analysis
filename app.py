...
if user_menu == 'Country-wise Analysis':
    ...
    country_df = helper.yearwise_medal_tally(
        df,
        selected_country
    )
    ...
    top10_df = helper.most_successful_countrywise(
        df,
        selected_country
    )
...
if user_menu == 'Athlete wise Analysis':
    ...
    # Sports age distribution
    x = []
    name = []

    famous_sports = [
        'Basketball', 'Judo', 'Football', 'Tug-Of-War',
    ...
    temp_df = helper.weight_v_height(
        df,
        selected_sport
    )
